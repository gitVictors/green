...
const ImageFormatInterface* GetFormatInterface(const img_lib::Path& path) {
    ...
    static const FormatInterface::PPM ppmInterface;
    static const FormatInterface::JPEG jpegInterface;
    static const FormatInterface::BMP  bmpInterface;
