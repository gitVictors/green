...
const std::optional<RouteOptimal>  RequestHandler::GetOptimalRoute(const std::string_view stop_from, const std::string_view stop_to) const {

    auto var = router_hd_->FindRoute(stop_from, stop_to);
