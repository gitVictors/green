...
//     size_t optional(const VehiclePlate& plate) {
//         array<char, 3> ar = plate.GetLetters();
//         //int lit = (ar[0] -'A') + (ar[1] -'A') + (ar[2] -'A');
//         int lit = (ar[0] - 'A') * 26 * 26 + (ar[1] - 'A') * 26 + (ar[2] - 'A');
//         return (plate.GetDigits()*1000000 + lit + plate.GetRegion()*1000);
//     }
// };
